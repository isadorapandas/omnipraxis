...
export function Model(props: ThreeElements['group']) {
  ...
  const morphMeshes = React.useMemo(() => {
    ...
    clone.traverse((node: any) => {
      if (node.isMesh || node.isSkinnedMesh) {
        node.frustumCulled = false; // Corrige a calça piscando
  ...
  useFrame((_, delta) => {
    ...
    // 5. TRANSIÇÃO LIMPA: Crossfade seguro
  ...
  // 6. RENDERIZAÇÃO ABSOLUTA: Apenas a malha clonada e limpa
  return (
